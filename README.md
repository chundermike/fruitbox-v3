...
2. Download the <code>fruitbox_3.01.01_arm64_portable.deb</code> file and save it to the Desktop
3. Open a command line terminal and type:<br>
    <code>sudo apt install ~/Desktop/fruitbox_3.01.01_arm64_portable.deb</code><br>
...
1. Download and run the <code>fruitbox_3.01.01_win64_setup.exe</code> file
